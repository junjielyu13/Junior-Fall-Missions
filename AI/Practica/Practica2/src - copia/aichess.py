...
class Aichess():
    ...
    def Minimax(self, depth = 4):
        ...
        def Minimax_aux(WhiteState, BlackState, depth, isMaximisingPlayer, weight):
            ...
            if depth == 0 or WhiteState == None or BlackState == None:
                if isMaximisingPlayer:
                    if self.whiteTurn:
                        return weight, WhiteState
                    else:
                        return weight, BlackState
                else:
                    if self.whiteTurn:
                        return weight, BlackState
                    else:
        ...
        return  Minimax_aux(self.currentStateW, self.currentStateB, depth, True, 0)[1]
    ...
    def AlfaBeta(self, currentState, depth = 4):
        ...
        def AlfaBeta_aux(WhiteState, BlackState, depth, alpha, beta, isMaximisingPlayer, weight):
            if depth == 0 or WhiteState == None or BlackState == None:
                ...
                if self.whiteTurn == self.whitePlayer:
                    return weight,  WhiteState
                else:
                    return weight,  BlackState
